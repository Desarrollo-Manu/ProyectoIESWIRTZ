...
$IdContacto  = obterPost('IdContacto',true,false,false,false,true);

if(comprobarUsuario($IdUsuario,null)&&comprobarIdContacto($IdContacto)){
    $resultado       =  delContacto($IdContacto);
}else{
    $resultado=null;
}
