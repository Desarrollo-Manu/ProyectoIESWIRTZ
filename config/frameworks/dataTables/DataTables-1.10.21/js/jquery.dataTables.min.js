...
d[c]=e,"o"===b[1]&&H(a[e]))});a._hungarianMap=d}function L(a,b,c){a._hungarianMap||H(a);var d;f.each(b,function(e,h){d=a._hungarianMap[e];d===n||!c&&b[d]!==n||("o"===d.charAt(0)?(b[d]||(b[d]={}),f.extend(!0,b[d],b[e]),L(a[d],b[d],c)):b[d]=b[e])})}function Fa(a){var b=q.defaults.oLanguage,c=b.sDecimal;c&&Ga(c);if(a){var d=a.sZeroRecords;!a.sEmptyTable&&d&&"Esta tabla no tiene datos."===b.sEmptyTable&&M(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&d&&"Loading..."===b.sLoadingRecords&&M(a,a,
...
sNext:"Next",sPrevious:"Previous"},sEmptyTable:"Esta tabla no tiene datos.",sInfo:"Viendo _START_ de _END_ . _TOTAL_ resultados",sInfoEmpty:"Viendo 0 para 0 de 0 resultados",sInfoFiltered:"(filtrado desde _MAX_ resultados totales)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Viendo _MENU_ resultados",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No se han encontrado resultados."},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
